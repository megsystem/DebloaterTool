...
namespace DebloaterTool
{
    public class ModuleList 
    {
        ...
        public static Dictionary<Action, TweakInfo> tweaks = new Dictionary<Action, TweakInfo>
        {
            ...
            { SecurityPerformance.DisableRemAssistAndRemDesk, new TweakInfo("Disable Remote Assistance and Desktop", false) },
            { SecurityPerformance.DisableSpectreAndMeltdown, new TweakInfo("Disable Spectre/Meltdown mitigations", false) },
            { SecurityPerformance.DisableWinErrorReporting, new TweakInfo("Disable Windows Error Reporting", false) },
            { SecurityPerformance.ApplySecurityPerformanceTweaks, new TweakInfo("Apply general security/performance tweaks", false) },
            { SecurityPerformance.DisableSMBv1, new TweakInfo("Disable outdated SMBv1 protocol", false) },
