...
namespace DebloaterTool.Settings
{
    public class ModuleList
    {
        ...
        public static IList<TweakModule> GetAllModules() => new List<TweakModule>
        {
            ...
            new TweakModule(WindowsTheme.StartAllBackInstaller, "Installs StartAllBack with silent installation", false),
            new TweakModule(WindowsTheme.WindowsActivator, "Windows Activator", false),
